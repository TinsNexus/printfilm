...
# 生成 Seedance 参考音短试听句（约 2–3 秒，对齐 ai-manju）
...
async def synthesize_voice_asset(
    ...
    *,
    ...
    # Seedance reference_audio 宜 2–15s；默认短句，未配槽位时走 preset TTS + 语气 context
    text = (sample_text or "").strip() or build_voice_sample_text(prompt, display_name, short=True)
