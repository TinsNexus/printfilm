...
export function TemplateCard({
  ...
  const categories = template.category?.length ? template.category : [tx("templateCard.uncategorized")];
  ...
  return (
    ...
    >
      <button
        ...
        aria-label={tx("templateCard.editTemplate", { templateName: template.name })}
      >
        {src ? (
        ...
        <div className="template-card-cover-meta">
          ...
          {!template.is_active ? (
            <span className="template-card-badge template-card-badge--off">{tx("templateCard.unlisted")}</span>
          ) : null}
        </div>
      </button>
      ...
      <div className="template-card-body">
        <div className="template-card-head">
          ...
          <div className="template-card-actions">
            <button type="button" className="template-card-icon-btn" onClick={() => onEdit(template)} title={tx("templateCard.edit")}>
        ...
        {template.description ? (
          ...
          <p className="template-card-desc template-card-desc--empty">{tx("templateCard.description")}</p>
        )}
        ...
        <div className="template-card-foot">
          <label className="template-card-toggle">
            <span>{tx("templateCard.listed")}</span>
            <Switch
