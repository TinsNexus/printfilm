...
export const zhPages = {
  home: {
    ...
    kepuTag: '获客短视频',
    kepuFor: '给要获客的品牌',
    kepuDesc: '把卖点做成可投放的短视频，选定风格后沿分镜流水线批量出片。',
    ...
    whoTitle: '适合谁用',
    closeTitle: '从一条创意开始',
    closeLead: '登录后选择漫剧或 AI短视频，进入对应工作台。',
    viewPricing: '查看定价',
    methodLink: '获客短视频方法论',
    ...
    capabilities: [
      ...
      { title: '两条出片路径', desc: '漫剧走分集叙事，AI短视频走分镜流水线，同一套账号与积分。' },
    ],
    audiences: [
      { title: '短剧创作者', desc: '把故事拆成可拍的分集，先出资产再成片。' },
      { title: '品牌获客', desc: '把卖点做成竖屏短视频，风格统一、可批量出片。' },
  ...
  history: {
    ...
    empty: '暂无 AI短视频项目，点击「新建短视频」开始创作',
    noCover: '无封面',
    published: '已发布',
