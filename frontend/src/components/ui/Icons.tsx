...
export function IconGithub(p: IconProps) {
  return (
    <svg
      ...
      aria-hidden
    >
      <path d="M12 2C6.477 2 2 6.584 2 12.217c0 4.506 2.865 8.33 6.839 9.68.5.094.682-.22.682-.486 0-.24-.009-.875-.014-1.717-2.782.616-3.369-1.366-3.369-1.366-.454-1.178-1.11-1.491-1.11-1.491-.908-.635.069-.622.069-.622 1.004.072 1.532 1.05 1.532 1.05.892 1.559 2.341 1.109 2.91.848.091-.66.35-1.11.636-1.365-2.22-.257-4.555-1.134-4.555-5.048 0-1.115.39-2.027 1.03-2.742-.103-.258-.447-1.296.098-2.701 0 0 .84-.274 2.75 1.046A9.38 9.38 0 0 1 12 6.918a9.38 9.38 0 0 1 2.504.344c1.909-1.32 2.747-1.046 2.747-1.046.547 1.405.203 2.443.1 2.701.64.715 1.028 1.627 1.028 2.742 0 3.924-2.339 4.788-4.566 5.04.359.315.679.938.679 1.891 0 1.365-.012 2.465-.012 2.8 0 .269.18.585.688.485A10.24 10.24 0 0 0 22 12.217C22 6.584 17.523 2 12 2z" />
    </svg>
  )
}
